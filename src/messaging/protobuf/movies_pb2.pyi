...
class Movie(_message.Message):
    __slots__ = ("id", "title", "genres", "release_date", "production_countries", "budget", "revenue", "overview")
    ...
    revenue: int
    overview: str
    def __init__(self, id: _Optional[int] = ..., title: _Optional[str] = ..., genres: _Optional[_Iterable[str]] = ..., release_date: _Optional[str] = ..., production_countries: _Optional[_Iterable[str]] = ..., budget: _Optional[int] = ..., revenue: _Optional[int] = ..., overview: _Optional[str] = ...) -> None: ...

class Movies(_message.Message):
    __slots__ = ("list",)
    LIST_FIELD_NUMBER: _ClassVar[int]
    list: _containers.RepeatedCompositeFieldContainer[Movie]
    def __init__(self, list: _Optional[_Iterable[_Union[Movie, _Mapping]]] = ...) -> None: ...
