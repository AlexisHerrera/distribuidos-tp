...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 29, 3, '', 'movies.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MOVIE']._serialized_start = 27
    _globals['_MOVIE']._serialized_end = 180
    _globals['_MOVIES']._serialized_start = 182
    _globals['_MOVIES']._serialized_end = 221
