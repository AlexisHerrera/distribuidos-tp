import logging
import os
from common.socket_communication import (
    receive_message,
...
def main():
    try:
        ...
        logging.warning(
            'Invalid SERVER_PORT environment variable. Falling back to default port 12345.'
        )
        port = 12345
    ...
    try:
        ...
        logging.warning(
            'Invalid LISTENING_BACKLOG environment variable. Falling back to default backlog 3.'
        )
        backlog = 3
